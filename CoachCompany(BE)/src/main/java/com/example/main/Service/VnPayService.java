...
import com.example.main.Config.VnPayConfig;
...
public class VnPayService {
    ...
    public String createOrder(int total, String orderInfor, String urlReturn, Long ticketId){
        String vnp_Version = "2.1.0";
        String vnp_Command = "pay";
        String vnp_TxnRef =  ticketId.toString(); //Mã vé được thêm vvaof
