...
export class DriverComponent implements OnInit {
  createUrl = '/admin/driver/create-driver';
      ...
      .subscribe({
        next: (response: any) => {
          if (this.pageType==="driver"){
            const drivers = this.employeeService.getDriverCurrent().filter(driver => driver.id !== id);
            this.employeeService.setUserList(drivers);
            this.driverList = this.employeeService.getDriverCurrent();
